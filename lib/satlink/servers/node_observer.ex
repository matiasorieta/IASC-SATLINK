defmodule Satlink.Servers.NodeObserver do
  use GenServer
  require Logger

  alias Satlink.Registries.WindowRegistry
  alias Satlink.Supervisors.WindowSupervisor
  ...
  def handle_info({:nodedown, node, _node_type}, state) do
    ...
    set_members(WindowRegistry)
    set_members(WindowSupervisor)
